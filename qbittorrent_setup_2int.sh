...
main() {
    ...
    echo "💡 使用技巧："
    echo "# 快速部署命令："
    echo "curl -sSL https://raw.githubusercontent.com/heshuiiii/commad-use/main/qbittorrent_setup_enhanced.sh | bash"
    echo ""
    echo "# 指定版本部署："
    echo "curl -sSL https://raw.githubusercontent.com/heshuiiii/commad-use/main/qbittorrent_setup_enhanced.sh | bash -s -- --version=4.6.7"
    echo ""
    echo "# 自动模式（无交互）："
    echo "curl -sSL https://raw.githubusercontent.com/heshuiiii/commad-use/main/qbittorrent_setup_enhanced.sh | bash -s -- --auto"
    echo ""
    echo "# 跳过增强配置："
    echo "curl -sSL https://raw.githubusercontent.com/heshuiiii/commad-use/main/qbittorrent_setup_enhanced.sh | bash -s -- --no-config"
    echo ""
